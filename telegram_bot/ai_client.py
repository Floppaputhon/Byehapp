...
_BOT_SELF_KNOWLEDGE = (
    ...
    "=== ИРИС-СТИЛЬ КОМАНДЫ (без /) ===\n"
    "Префиксы: !, ., /, Ирис, Ириска\n"
    "Примеры: !варн спам, .бан 2 дня реклама, Ирис кик, Ириска мут 1 час\n"
...
_IRIS_KNOWLEDGE = (
    ...
    "ПРЕФИКСЫ КОМАНД: !, ., /, Ирис, Ириска\n"
    "Пример: !варн, .бан, /мут, Ирис кик, Ириска варн\n\n"
    "СИСТЕМА ПРЕДУПРЕЖДЕНИЙ (варны):\n"
    "- варн [период] [причина] — выдать предупреждение (ответом на сообщение)\n"
    "  Примеры: !варн спам, .варн 2 дня оскорбления, Ирис варн 1 час флуд\n"
    ...
    "  Примеры: !мут 1 час, .мут 30 минут флуд, Ирис заткни 2 часа\n"
    ...
    "  Примеры: !бан, .бан 1 неделя реклама, Ирис бан навсегда\n"
